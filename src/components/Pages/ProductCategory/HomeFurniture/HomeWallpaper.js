...
const HomeWallpaper = () => {
	...
	const getFacts = () => {
		const res = axiosInst.get(`/product?category=home&type=wallpaper`).then((response) => {
			return response
		})
		return res;
	};
	...
	return (
		<div className='min-h-screen'>
			<div className=''>
				<h1 className='capitalize text-3xl text-gray-900 text-center my-5 font-semibold'>Home Wallpaper</h1>
