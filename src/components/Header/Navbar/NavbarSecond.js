...
if (value) {
    ...
    return (
        <div className={`${myValue} md:block ${value} `}>
            <div className={`flex gap-5    `}>
                ...
                <div className="dropdown dropdown-hover ">
                    ...
                    <ul tabIndex={0} className="dropdown-content menu p-2 shadow  bg-white w-52 absolute border-none rounded-none shadow-none">
